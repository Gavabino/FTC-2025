...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0014424795326769598;
        public double trackWidthTicks = 7083.666823453898;

        // feedforward parameters (in tick units)
        public double kS = 1.1869315355300483;
        public double kV = 0.0003673757824074255;
